...
import { PEDIGREE_LEVEL_BAND } from '../src/lib/game/balance';
...
describe('quem joga sozinho contra bots pega o campo aliviado', () => {
  ...
  it('a fila sem adversário alivia o campo, igual ao solo', () => {
    ...
    // Sem alívio nenhum bot desceria abaixo do degrau de entrada (PEDIGREE_LEVEL_BAND.noneFiller).
    const semAlivio = PEDIGREE_LEVEL_BAND.noneFiller[0];
