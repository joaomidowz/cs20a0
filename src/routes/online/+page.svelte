<script lang="ts">
  ...
  /** Boost de farm: store consumable — with the switch ON, each solo major consumes 1 item and resolves 10 instantly. */
  const BOOST_SWITCH_KEY = 'cs13a0:boost-switch';
