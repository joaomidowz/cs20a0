...
<style>
  ...
  .odds-sheet { position: absolute; top: 30px; right: 0; display: grid; gap: 10px; width: 270px; padding: 14px; border: 1px solid var(--accent); background: var(--surface); box-shadow: 0 14px 40px rgb(0 0 0 / .55); text-align: left; }
