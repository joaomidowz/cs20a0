...
const pt = {
  ...
  pick: 'Pick',
  decider: 'Decider',
  replay: 'Replay tática',
  replayWaiting: 'O radar está pronto. Inicie a série para receber o primeiro round.',
  replayPlay: 'Reproduzir replay',
  replayPause: 'Pausar replay',
  replayStats: 'Estatísticas da replay',
  replayKills: 'K',
  replayDeaths: 'D',
  replayDamage: 'Dano',
  replayAssists: 'A',
  replayFlashAssists: 'Flash',
  replayTrades: 'Trade',
  replayLevel: 'Piso',
  replayControls: 'Controles locais da replay',
  replayLive: 'Na ponta ao vivo',
  replayDelayed: 'Replay atrasada',
  replayGoLive: 'Voltar ao vivo',
  replayChooseRound: 'Escolher round da replay',
...
Object.assign(dictionaries.es, {
  ...
  pick: 'Pick',
  decider: 'Decisivo',
  replay: 'Replay táctica',
  replayWaiting: 'El radar está listo. Inicia la serie para recibir la primera ronda.',
  replayPlay: 'Reproducir replay',
  replayPause: 'Pausar replay',
  replayStats: 'Estadísticas de la replay',
  replayDamage: 'Daño',
  replayFlashAssists: 'Flash',
  replayTrades: 'Trade',
  replayLevel: 'Piso',
  replayControls: 'Controles locales de la replay',
  replayLive: 'En directo',
  replayDelayed: 'Replay retrasada',
  replayGoLive: 'Volver al directo',
  replayChooseRound: 'Elegir ronda de la replay'
});
...
Object.assign(dictionaries.en, {
  ...
  replayWaiting: 'The radar is ready. Start the series to receive the first round.',
  replayPlay: 'Play replay',
  replayPause: 'Pause replay',
  replayStats: 'Replay statistics',
  replayDamage: 'Damage',
  replayFlashAssists: 'Flash',
  replayTrades: 'Trade',
  replayLevel: 'Level',
  replayControls: 'Local replay controls',
  replayLive: 'Live edge',
  replayDelayed: 'Replay behind live',
  replayGoLive: 'Go live',
  replayChooseRound: 'Choose replay round'
});
