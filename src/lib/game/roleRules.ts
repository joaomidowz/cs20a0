...
const KNOWN_ROLE_FALLBACKS: Record<string, LineupSlotRole[]> = {
  ...
  torzsi: ['awper'],
  kennys: ['awper'],
  amanek: ['awper', 'support'],
  molodoy: ['awper'],
  donk: ['entry', 'rifler'],
  yekindar: ['entry', 'rifler'],
  rain: ['entry', 'rifler'],
  taco: ['entry', 'support'],
  ropz: ['lurker'],
  fer: ['lurker', 'rifler'],
  coldzera: ['rifler', 'awper'],
  kscerato: ['lurker', 'support', 'rifler'],
  naf: ['lurker', 'rifler'],
  ...
  jackz: ['support', 'entry'],
  tn1r: ['support', 'rifler'],
  yuurih: ['support', 'rifler'],
  boltz: ['support', 'rifler'],
  nitr0: ['igl', 'awper'],
  stewie2k: ['entry', 'support'],
  elige: ['rifler', 'entry'],
  twistzz: ['rifler', 'support'],
  tarik: ['rifler', 'entry'],
  hunter: ['rifler', 'lurker'],
  niko: ['rifler', 'entry'],
  jl: ['rifler', 'support'],
  im: ['rifler', 'entry']
};
