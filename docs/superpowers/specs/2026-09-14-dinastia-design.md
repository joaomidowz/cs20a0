...
5. **Revisão após o teste no navegador** (plano mestre em `/home/itcenterai/.claude/plans/certo-quero-que-mande-harmonic-catmull.md`, implementada no branch `feat/dinastia`): formato real dos Majors de 2026 (MD1/MD3 nos Stages 1 e 2, Stage 3 em MD3) e título do estágio ao vivo; estilo, tática do coach e estudo por série com aba Time; treino pré-Major com ganho permanente; janela em cartas com penalidade de posição, trocas diretas e histórico por Major; fila 2x2, dicas de tutorial e roleta do coach; circuito de campeonatos menores entre Majors com prêmio no caixa. Planos por fase: `docs/superpowers/plans/2026-09-14-dinastia-r4-janela-cartas.md`, `2026-09-14-dinastia-r5-fila-dicas-roleta.md` e `2026-09-14-dinastia-r6-circuito-renda.md` (as Fases 1 a 3 seguiram direto o plano mestre).
